...
import com.example.jd158.inventory.InventoryDbHelper;
...
public class InventoryProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        // Initialize the variable using the PetDbHelper contractor
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case INVENTORY:
                ...
                cursor = database.query(InventoryContract.InventoryEntry.TABLE_NAME, projection, null, null,
                        null, null, sortOrder);
                break;
            case INVENTORY_ID:
    ...
    private Uri insertInventory(Uri uri, ContentValues values) {
        ...
        // Check if quantity is provider
        Integer quantity = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_ITEM_QUANTITY);
        if (quantity < 0) {
            throw new IllegalArgumentException("Quantity might be bigger than 0");
        }
        ...
        // Check that the name is not null
        String picture = values.getAsString(InventoryContract.InventoryEntry.COLUMN_INVENTORY_PICTURE);
        if (picture == null) {
